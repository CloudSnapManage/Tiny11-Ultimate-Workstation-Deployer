...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/CloudSnapManage/Tiny11-Ultimate-Workstation-Deployer.git](https://github.com/CloudSnapManage/Tiny11-Ultimate-Workstation-Deployer.git)
    ```
